...
- **Who**: Edu, 37, software engineer, based in Andorra.
- **Goal**: hypertrophy + strength with a longevity governor — get strong,
  look good, don't get hurt. Training + recovery scope; nutrition off-scope
  for now.
- **Starting point**: detrained but not weak (layoff after an injury + a
...
Real details (stats, injury history, schedule) live in `profile.private.md`,
which is local-only and never committed.
